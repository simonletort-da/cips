...
CIP editors subscribe to the [cip-discuss mailing list](https://lists.sync.global/g/cip-discuss/topics). Authors may also reach out to CIP editors directly.
...
- The CIP has been sent to the [cip-discuss mailing list](https://lists.sync.global/g/cip-discuss/topics) for discussion.
