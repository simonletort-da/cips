...
During discussions, and before proposing the CIP for a vote, the proposal should be submitted to the [cips git repository](https://github.com/global-synchronizer-foundation/cips) as a pull request.
